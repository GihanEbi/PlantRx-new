...
const SiteWideAnalytics = lazy(() => import('@/components/SEOEnhancements').then(m => ({ default: m.SiteWideAnalytics })));
const GoogleSearchConsole = lazy(() => import('@/components/SEOEnhancements').then(m => ({ default: m.GoogleSearchConsole })));
const CoreWebVitalsOptimization = lazy(() => import('@/components/SEOEnhancements').then(m => ({ default: m.CoreWebVitalsOptimization })));
const WebVitalsTracker = lazy(() => import('@/components/WebVitalsTracker').then(m => ({ default: m.WebVitalsTracker })));
const MobileOptimization = lazy(() => import('@/components/MobileOptimization').then(m => ({ default: m.MobileOptimization })));
...
const HowNaturalRemediesHeal = lazy(() => import("@/pages/content/HowNaturalRemediesHeal"));
const ImmunityBoostingHerbs = lazy(() => import("@/pages/content/ImmunityBoostingHerbs"));
const HerbalRoutineGuide = lazy(() => import("@/pages/content/HerbalRoutineGuide"));
const NaturalStressRelief = lazy(() => import("@/pages/content/NaturalStressRelief"));
const DigestiveHealthGuide = lazy(() => import("@/pages/content/DigestiveHealthGuide"));
const NaturalSleepRemedies = lazy(() => import("@/pages/content/NaturalSleepRemedies"));
const NaturalSkinCare = lazy(() => import("@/pages/content/NaturalSkinCare"));
const AntiInflammatoryHerbs = lazy(() => import("@/pages/content/AntiInflammatoryHerbs"));
const NaturalPainRelief = lazy(() => import("@/pages/content/NaturalPainRelief"));
const ImmuneSystemBoost = lazy(() => import("@/pages/content/ImmuneSystemBoost"));
...
const ArticlesHerbsRemedies = lazy(() => import("@/pages/ArticlesHerbsRemedies"));
...
const ToolsBlueprintDesigner = lazy(() => import("@/pages/ToolsBlueprintDesigner"));
const ToolsHealthCalculators = lazy(() => import("@/pages/ToolsHealthCalculators"));
      ...
      <div className="pt-20">
        ...
        <Suspense fallback={<SuspenseFallback />}>
          <Switch>
            ...
            <Route path="/remedies/category/:category" component={RemedyCategoryPage} />
            ...
            <Route path="/collections/Products" component={() => {
            ...
            <Route path="/planrx-creator" component={() => <PlanRxCreator user={null} onAuthRequired={() => {}} />} />
            ...
            <Route path="/articles/herbs-remedies" component={ArticlesHerbsRemedies} />
            <Route path="/articles/healthy-foods" component={ArticlesHealthyFoods} />
            <Route path="/articles/mental-health" component={ArticlesMentalHealth} />
            <Route path="/articles/skin-beauty" component={ArticlesSkinBeauty} />
            ...
            <Route path="/tools/symptom-finder" component={ToolsSymptomFinder} />
            <Route path="/tools/remedy-builder" component={ToolsRemedyBuilder} />
            <Route path="/tools/blueprint-designer" component={ToolsBlueprintDesigner} />
            <Route path="/tools/health-calculators" component={ToolsHealthCalculators} />
            ...
            <Route path="/learn/how-natural-remedies-heal" component={HowNaturalRemediesHeal} />
            <Route path="/learn/immunity-boosting-herbs" component={ImmunityBoostingHerbs} />
            <Route path="/learn/herbal-routine-guide" component={HerbalRoutineGuide} />
            <Route path="/learn/natural-stress-relief" component={NaturalStressRelief} />
            <Route path="/learn/digestive-health-guide" component={DigestiveHealthGuide} />
            <Route path="/learn/natural-sleep-remedies" component={NaturalSleepRemedies} />
            <Route path="/learn/natural-skin-care" component={NaturalSkinCare} />
            <Route path="/learn/anti-inflammatory-herbs" component={AntiInflammatoryHerbs} />
            <Route path="/learn/natural-pain-relief" component={NaturalPainRelief} />
            <Route path="/learn/boost-immune-system" component={ImmuneSystemBoost} />
