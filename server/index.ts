...
import { httpsRedirect, securityHeaders, botFilter } from "./middleware/security";
...
app.use((req, res, next) => {
  ...
  if (url.includes('/assets/') || url.match(/\.[a-f0-9]{8}\.(js|css|woff2?|ttf|eot|svg|png|jpg|jpeg|gif|webp|avif|ico)$/)) {
  ...
  try {
    ...
    if (event.type === 'checkout.session.completed') {
      ...
      if (userId && tier && session.subscription) {
        ...
        console.log(`Subscription activated for user ${userId}: ${tier} (hasEverPaidSubscription: true)`);
      }
    }
...
<sitemapindex xmlns="http://www.sitemaps.org/schemas/sitemap/0.9">
  ...
  <sitemap><loc>${baseUrl}/sitemap-experts.xml</loc><lastmod>${currentDate}</lastmod></sitemap>
    ...
    res.status(200).type('application/xml').send('<?xml version="1.0"?><urlset xmlns="http://www.sitemaps.org/schemas/sitemap/0.9"><url><loc>https://plantrxapp.com/</loc></url></urlset>');
  }
});
...
app.get('/sitemap-remedies.xml', (req, res) => {
  ...
  const remedySlugs = [
    'acupressure-headache-points', 'aloe-formula-110', 'aloe-formula-123', 'aloe-formula-19',
    'aloe-formula-32', 'aloe-formula-45', 'aloe-formula-58', 'aloe-formula-6', 'aloe-formula-71',
    'aloe-formula-84', 'aloe-formula-97', 'apple-cider-vinegar-digestive', 'bacopa-learning-enhancement',
    'baking-soda-headache-drink', 'baking-soda-heartburn-relief', 'banana-potassium-cramp-relief',
    'butterbur-migraine-prevention', 'calendula-formula-103', 'calendula-formula-116', 'calendula-formula-12',
    'calendula-formula-129', 'calendula-formula-25', 'calendula-formula-38', 'calendula-formula-51',
    'calendula-formula-64', 'calendula-formula-77', 'calendula-formula-90', 'chamomile-formula-108',
    'chamomile-formula-121', 'chamomile-formula-17', 'chamomile-formula-30', 'chamomile-formula-4',
    'chamomile-formula-43', 'chamomile-formula-56', 'chamomile-formula-69', 'chamomile-formula-82',
    'chamomile-formula-95', 'chamomile-tea-sleep-aid', 'chanca-piedra-stone-breaker', 'coffee-headache-treatment',
    'cold-heat-headache-therapy', 'cooling-peppermint-temple-balm', 'corn-silk-kidney-support',
    'cucumber-eye-compress', 'dandelion-liver-detox-tea', 'dandelion-nettle-kidney-cleanse',
    'deep-breathing-headache-relief', 'digestive-support-tea', 'echinacea-formula-111', 'echinacea-formula-124',
    'echinacea-formula-20', 'echinacea-formula-33', 'echinacea-formula-46', 'echinacea-formula-59',
    'echinacea-formula-7', 'echinacea-formula-72', 'echinacea-formula-85', 'echinacea-formula-98',
    'echinacea-throat-support', 'epsom-salt-foot-soak', 'feverfew-migraine-prevention', 'garlic-formula-10',
    'garlic-formula-101', 'garlic-formula-114', 'garlic-formula-127', 'garlic-formula-23',
    'garlic-formula-36', 'garlic-formula-49', 'garlic-formula-62', 'garlic-formula-75',
    'garlic-formula-88', 'garlic-immune-booster', 'ginger-formula-1', 'ginger-formula-105',
    'ginger-formula-118', 'ginger-formula-131', 'ginger-formula-14', 'ginger-formula-27',
    'ginger-formula-40', 'ginger-formula-53', 'ginger-formula-66', 'ginger-formula-79',
    'ginger-formula-92', 'ginger-nausea-tea', 'ginger-turmeric-headache-tea', 'ginkgo-memory-enhancement',
    'green-tea-formula-100', 'green-tea-formula-113', 'green-tea-formula-126', 'green-tea-formula-22',
    'green-tea-formula-35', 'green-tea-formula-48', 'green-tea-formula-61', 'green-tea-formula-74',
    'green-tea-formula-87', 'green-tea-formula-9', 'honey-formula-107', 'honey-formula-120',
    'honey-formula-133', 'honey-formula-16', 'honey-formula-29', 'honey-formula-3', 'honey-formula-42',
    'honey-formula-55', 'honey-formula-68', 'honey-formula-81', 'honey-formula-94', 'honey-ginger-throat-soother',
    'honey-lemon-cough-syrup', 'hydration-electrolyte-headache', 'ice-pack-towel-therapy', 'juniper-kidney-detox',
    'lavender-chamomile-headache-relief', 'lavender-formula-112', 'lavender-formula-125', 'lavender-formula-21',
    'lavender-formula-34', 'lavender-formula-47', 'lavender-formula-60', 'lavender-formula-73',
    'lavender-formula-8', 'lavender-formula-86', 'lavender-formula-99', 'lions-mane-brain-tonic',
    'magnesium-b-complex-support', 'marshmallow-root-throat-tea', 'milk-thistle-liver-protection',
    'neck-shoulder-headache-stretches', 'oatmeal-soothing-skin-mask', 'panax-ginseng-cognitive-tea',
    'peppermint-formula-109', 'peppermint-formula-122', 'peppermint-formula-18', 'peppermint-formula-31',
    'peppermint-formula-44', 'peppermint-formula-5', 'peppermint-formula-57', 'peppermint-formula-70',
    'peppermint-formula-83', 'peppermint-formula-96', 'rice-water-hair-treatment', 'sage-throat-gargle',
    'salt-water-headache-relief', 'schisandra-liver-regeneration', 'soothing-herbal-balm-for-rough-skin',
    'soothing-herbal-skin-balm', 'test-ginger-honey-remedy', 'turmeric-formula-106', 'turmeric-formula-119',
    'turmeric-formula-132', 'turmeric-formula-15', 'turmeric-formula-2', 'turmeric-formula-28',
    'turmeric-formula-41', 'turmeric-formula-54', 'turmeric-formula-67', 'turmeric-formula-80',
    'turmeric-formula-93', 'turmeric-golden-milk', 'turmeric-liver-support', 'valerian-formula-104',
    'valerian-formula-117', 'valerian-formula-13', 'valerian-formula-130', 'valerian-formula-26',
    'valerian-formula-39', 'valerian-formula-52', 'valerian-formula-65', 'valerian-formula-78',
    'valerian-formula-91', 'willow-bark-headache-remedy', 'willow-formula-102', 'willow-formula-11',
    'willow-formula-115', 'willow-formula-128', 'willow-formula-24', 'willow-formula-37',
    'willow-formula-50', 'willow-formula-63', 'willow-formula-76', 'willow-formula-89'
  ];
  
  const remedyUrls = remedySlugs
    .map(slug => `  <url><loc>${baseUrl}/remedies/${slug}</loc><lastmod>${currentDate}</lastmod></url>`)
    .join('\n');
...
app.use((req, res, next) => {
  ...
  const path = req.path;
  const userAgent = req.get('User-Agent') || '';
  const isBot = /bot|crawler|spider|googlebot|bingbot|facebookexternalhit/i.test(userAgent);
  const isCriticalPath = ['/', '/robots.txt', '/sitemap.xml', '/__health'].includes(path);
  ...
  res.on("finish", () => {
    ...
    if (isBot || isCriticalPath || res.statusCode >= 400) {
      console.log(`🔍 ${isBot ? '🤖 BOT' : '👤 USER'} ${logLine} | UA: ${userAgent.substring(0, 50)}`);
      
      // Alert on non-200 responses to critical paths
      if (isCriticalPath && res.statusCode !== 200) {
        console.error(`🚨 CRITICAL: Non-200 response to ${path}: ${res.statusCode}`);
      }
    }
...
const remedyImagesPath = path.resolve(import.meta.dirname, "..", "attached_assets", "remedy_images");
app.use("/attached_assets/remedy_images", express.static(remedyImagesPath, {
...
(async () => {
  ...
  (async () => {
    try {
      const { initializeCurrencyRates, scheduleCurrencyUpdates } = await import("./currency-service");
  ...
  app.use((err: any, req: Request, res: Response, _next: NextFunction) => {
    const userAgent = req.get('User-Agent') || '';
    const isBot = /bot|crawler|spider|googlebot|bingbot|facebookexternalhit/i.test(userAgent);
    const isCriticalPath = ['/', '/robots.txt', '/sitemap.xml', '/__health'].includes(req.path);
